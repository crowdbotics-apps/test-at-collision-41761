"""
Django settings for test_at_collision_41761 project.
...
ROOT_URLCONF = 'test_at_collision_41761.urls'
...
WSGI_APPLICATION = 'test_at_collision_41761.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_at_collision_41761 API",
    "DESCRIPTION": "API documentation for test_at_collision_41761 App",
    "VERSION": "v1",
}
