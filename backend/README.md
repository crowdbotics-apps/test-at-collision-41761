...
## Project Structure
    ...
    ├── test_at_collision_41761  # Django project configurations
...
1. Clone this repo and `cd test_at_collision_41761`
...
2. Clone this repo and `cd test_at_collision_41761`
